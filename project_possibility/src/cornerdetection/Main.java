...
public class Main {
    ...
    public static void DisplayImage(int finalOut[],String filename, int displayImageWidth, int displayImageHeight,int flag)
    {
     ...
     {
         //ExtractBill("C:\\Users\\Nimish\\Desktop\\Harris Corner Detection\\TestImages\\04202008005.jpg");
     }
     ...
     */
    public static void ExtractBill(String file) throws IOException
    {
        String index = file;//"C:\\Users\\Nimish\\Desktop\\Harris Corner Detection\\TestImages\\0420200800";//05";
        //int i = 10;
        //for(int i = 5; i < 10; i++)
        //{
            // Initialization
            ...
            {            
                ...
                grabber.grabPixels();
                DisplayImage(temp, index.substring(0, index.length() - 4) + "_OUTPUT"  , M, N,1);
